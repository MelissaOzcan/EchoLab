...
function Home() {
    ...
    const handleSubmitCreate = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post('https://3.142.174.77:4000/home', { username: username }, {
    ...
    const handleSubmitJoin = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`https://3.142.174.77:4000/home/join`, { roomId: roomId, username: username }, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
    ...
    const handleDeleteUser = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.delete(`https://3.142.174.77:4000/deleteuser/${username}`, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
